    ...
    return (
        <div style={{ padding: "60px 20px", maxWidth: "800px", margin: "0 auto", color: "var(--color-foreground)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
                <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "linear-gradient(135deg, #10B981 0%, #34D399 100%)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                    <ShieldCheck size={24} color="white" />
                </div>
                <h1 style={{ fontSize: "32px", fontWeight: 700, letterSpacing: "-0.02em" }}>Medical Data Processing Policy</h1>
            </div>
            ...
            <div style={{ fontSize: "15px", lineHeight: 1.7, color: "var(--color-muted-foreground)", display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div style={{ padding: "24px", background: "var(--color-surface-secondary)", borderRadius: "16px", border: "1px solid var(--color-border)", margin: "16px 0" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px", color: "var(--color-foreground)", fontWeight: 600 }}>
                ...
                <h2 style={{ fontSize: "20px", fontWeight: 600, color: "var(--color-foreground)", marginTop: "16px", display: "flex", alignItems: "center", gap: "10px" }}>
                    <HardDrive size={18} /> Model Context Protocol (MCP)
                </h2>
                <p>
                ...
                <h2 style={{ fontSize: "20px", fontWeight: 600, color: "var(--color-foreground)", marginTop: "16px", display: "flex", alignItems: "center", gap: "10px" }}>
                    <FileText size={18} /> Automated Analysis Consent
                </h2>
                <p>
